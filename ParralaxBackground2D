...
/// <summary>
/// Used to move the position of a sprite relative to the player's position, creating the illusion of depth.
/// This script moves ONE sprite. Use this script for each sprite you want to move.
/// This code comes from a CodeMonkey video on YouTube.
/// </summary>
public class ParralaxBackground2D : MonoBehaviour
{
    [Header("Setup:")]
